...
export default function Fincas() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setShowModal(false); setEditId(null); setForm({ nombre: '', ubicacion: '', altitud: '', superficie_total: '' });
      cargarFincas();
  ...
  function abrirEditar(f) {
    setEditId(f.id);
    setForm({ nombre: f.nombre, ubicacion: f.ubicacion || '', altitud: f.altitud || '', superficie_total: f.superficie_total || '' });
    setShowModal(true);
  }
